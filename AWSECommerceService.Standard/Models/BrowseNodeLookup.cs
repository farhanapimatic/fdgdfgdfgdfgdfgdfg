...
{
    public class BrowseNodeLookup : BaseModel 
    {
        ...
        private Models.BrowseNodeLookupRequest shared;
        private List<Models.BrowseNodeLookupRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.BrowseNodeLookupRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.BrowseNodeLookupRequest> Request 
        { 
            get 
            {
                return this.request; 
