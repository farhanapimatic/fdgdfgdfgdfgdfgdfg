...
{
    public class ItemSearch : BaseModel 
    {
        ...
        private Models.ItemSearchRequest shared;
        private List<Models.ItemSearchRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.ItemSearchRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.ItemSearchRequest> Request 
        { 
            get 
            {
                return this.request; 
