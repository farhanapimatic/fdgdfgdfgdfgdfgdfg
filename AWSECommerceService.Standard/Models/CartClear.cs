...
{
    public class CartClear : BaseModel 
    {
        ...
        private Models.CartClearRequest shared;
        private List<Models.CartClearRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartClearRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartClearRequest> Request 
        { 
            get 
            {
                return this.request; 
