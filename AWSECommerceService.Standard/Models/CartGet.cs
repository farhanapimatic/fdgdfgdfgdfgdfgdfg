...
{
    public class CartGet : BaseModel 
    {
        ...
        private Models.CartGetRequest shared;
        private List<Models.CartGetRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartGetRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartGetRequest> Request 
        { 
            get 
            {
                return this.request; 
