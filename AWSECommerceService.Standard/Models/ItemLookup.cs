...
{
    public class ItemLookup : BaseModel 
    {
        ...
        private Models.ItemLookupRequest shared;
        private List<Models.ItemLookupRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.ItemLookupRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.ItemLookupRequest> Request 
        { 
            get 
            {
                return this.request; 
