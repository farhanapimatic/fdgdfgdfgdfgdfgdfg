...
{
    public class CartCreate : BaseModel 
    {
        ...
        private Models.CartCreateRequest shared;
        private List<Models.CartCreateRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartCreateRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartCreateRequest> Request 
        { 
            get 
            {
                return this.request; 
