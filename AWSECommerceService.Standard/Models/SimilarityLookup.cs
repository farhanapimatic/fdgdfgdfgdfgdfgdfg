...
{
    public class SimilarityLookup : BaseModel 
    {
        ...
        private Models.SimilarityLookupRequest shared;
        private List<Models.SimilarityLookupRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.SimilarityLookupRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.SimilarityLookupRequest> Request 
        { 
            get 
            {
                return this.request; 
