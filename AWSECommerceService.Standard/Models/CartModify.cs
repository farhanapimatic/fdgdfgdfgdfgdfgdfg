...
{
    public class CartModify : BaseModel 
    {
        ...
        private Models.CartModifyRequest shared;
        private List<Models.CartModifyRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartModifyRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartModifyRequest> Request 
        { 
            get 
            {
                return this.request; 
