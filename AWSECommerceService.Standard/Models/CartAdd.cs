...
{
    public class CartAdd : BaseModel 
    {
        ...
        private Models.CartAddRequest shared;
        private List<Models.CartAddRequest> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartAddRequest Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartAddRequest> Request 
        { 
            get 
            {
                return this.request; 
